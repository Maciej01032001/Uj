...
class Rectangle:
    ...
    def __str__(self):
            return Rectangle(self.pt1.x,self.pt1.y,self.pt2.x,self.pt2.y)# "[(x1, y1), (x2, y2)]"

    def __repr__(self):        # "Rectangle(x1, y1, x2, y2)"
        return Rectangle.__name__, Rectangle(self.pt1.x, self.pt1.y, self.pt2.x, self.pt2.y)
    ...
    def intersection(self, other):
        ...
        if (self.pt2.x<other.pt1.x or self.pt2.y<other.pt1.y or other.pt2.x<self.pt1.x or other.pt2.y< self.pt1.y):
            try:
                raise ValueError
            except ValueError:
...
class TestRectangle(unittest.TestCase):
    ...
    def test__str__(self):
        self.assertEqual(self.prostokat.__str__(), Rectangle(0, 0, 4, 4))

    def test__repr__(self):
        self.assertEqual(self.prostokat.__repr__(), ('Rectangle', Rectangle(0, 0, 4, 4)))
    ...
    def test_intersection(self):
        ...
        self.assertEqual(self.prostokat.intersection(self.prostokat2), "Prostokaty maja czesc wspolna")
